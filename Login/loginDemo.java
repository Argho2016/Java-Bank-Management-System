...
public class loginDemo extends javax.swing.JFrame implements ActionListener {
    ...
    private JComboBox loginOtption;
    ...
    public loginDemo() {
        ...
        loginOtption = new JComboBox(optionStrings);
        loginOtption.setSelectedIndex(1);
        loginOtption.setBackground(new java.awt.Color(236, 236, 236));
        loginOtption.setFont(new java.awt.Font("Tahoma", 1, 20));
        loginOtption.setForeground(new java.awt.Color(34, 49, 63));
        loginOtption.setBounds(180, 200, 160, 30);
        loginOtption.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == loginButton) {
            if (text.length() == 0) {
                ...
                String msg = (String) loginOtption.getSelectedItem();
